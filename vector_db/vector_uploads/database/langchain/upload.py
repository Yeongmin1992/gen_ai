...
# SH_DOC_DIR = os.path.join(DATA_DIR, "shinhan-test") 
...
def upload_embeddings_from_dir(dir_path):
    ...
    for root, dirs, files in os.walk(dir_path):
        print(files)
        for file in files:
            if file.endswith(".py") or file.endswith(".md") or file.endswith(".ipynb") or file.endswith(".csv"):
...
if __name__ == "__main__":
    print("start")
    # upload_embeddings_from_dir(SH_DOC_DIR)
